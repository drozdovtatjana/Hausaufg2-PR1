...
//Schreiben Sie ein Programm, welches vom Benutzer eine Zahl n übernimmt. Anschließend sollen vom Benutzer n
// in ein Array eingelesen werden. Danach lassen Sie den Benutzer eine weitere Zahl k wählen (größer 0).
// Es sollen aus dem Array alle Wörter, die kürzer k sind entfernt werden. Zum Schluss geben Sie die übriggebliebenen Elemente des Arrays aus (ohne die gelöschten Stellen).
